...
class SearchReviewServiceTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->service = new SearchReviewService($this->client);
    }
    ...
    public function test_returns_ids_and_total(): void
    {
        ...
        [$ids, $total] = $this->service->search(new ReviewFiltersDto());
    ...
    public function test_uses_match_all_when_search_and_id_are_null(): void
    {
        ...
        $this->service->search(new ReviewFiltersDto());
    }
