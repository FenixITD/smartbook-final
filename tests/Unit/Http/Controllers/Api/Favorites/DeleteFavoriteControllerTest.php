...
final class DeleteFavoriteControllerTest extends TestCase
{
    private MockInterface&FavoriteRepositoryInterface $repository;
    private DeleteFavoriteController $controller;
    ...
    protected function setUp(): void
    {
        ...
        $this->controller = $this->app->make(DeleteFavoriteController::class);
    }
    ...
    public function test_response_contains_success_message(): void
    {
        ...
        $this->assertSame('Favorite deleted successfully', $data['message']);
    }
    ...
    public function test_returns_200_even_when_favorite_not_found(): void
    {
        $this->repository
            ->shouldReceive('delete')
            ->with(999)
