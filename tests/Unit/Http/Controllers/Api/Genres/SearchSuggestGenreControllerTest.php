...
final class SearchSuggestGenreControllerTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->service = Mockery::mock(SearchSuggestGenreService::class);
        $this->app->instance(SearchSuggestGenreService::class, $this->service);
    ...
    public function test_returns_200_with_suggestions(): void
    {
        $this->service
            ...
            ->with('fan')
            ->andReturn([
                ['id' => 1, 'name' => 'Fantasy', 'url' => 'http://example.test/genres/1'],
                ['id' => 2, 'name' => 'Fantastic Realism', 'url' => 'http://example.test/genres/2'],
            ]);

        $response = ($this->controller)($this->makeRequest('fan'));
