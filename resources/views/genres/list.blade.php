                            ...
                            <tr class="hover:bg-zinc-50 dark:hover:bg-zinc-800 transition-colors">
                                ...
                                <td class="px-6 py-4 text-right">
                                    <div class="flex justify-end gap-2">
                                        <flux:button href="{{ route('genres.show', $genre) }}" variant="ghost" size="sm" icon="eye">View</flux:button>
                                        <flux:button href="{{ route('genres.edit', $genre) }}" variant="ghost" size="sm" icon="pencil">Edit</flux:button>
                                        <div>
